...
*   **Diagnóstico**: `ping` e `traceroute` para o IP do servidor de e-mail revelam que o tráfego está morrendo em algum ponto da rede do [[ISP]] da filial.
*   **Causa Raiz**: O servidor de e-mail está no Canadá, mas por algum erro de rota no lado da **Digital Ocean** ou de seus provedores de trânsito (`BGP`), o tráfego estava sendo desviado erroneamente para a **Europa** e se perdendo lá. O [[ISP]] da filial não tinha culpa direta, mas seu caminho padrão para a Digital Ocean estava comprometido devido a um problema externo que não podia controlar.
...
Com essa rota, todo o tráfego destinado ao servidor de e-mail da Digital Ocean daquela filial será **forçado** a passar pelo túnel VPN até o CD/Matriz, e de lá sair para a internet, contornando o problema de rota externo.
...
Esse tipo de solução demonstra o poder e a flexibilidade que o controle de roteamento oferece em cenários de **troubleshooting** complexos, especialmente quando o problema está fora do seu controle direto.